  ...
  translation: {
    ...
    settings: {
      ...
      tailscale: {
        ...
        preferenceUnknown:
          'Результат смены автозапуска неизвестен. Проверяем состояние устройства…',
        preferenceNotChanged: 'Автозапуск не был изменён.',
        memory: {
      ...
      netbird: {
        ...
        uninstallWarning:
          'Если вы подключены через NetBird, это оборвёт ваше соединение. Другая VPN не будет автоматически включена или выбрана; перед удалённым доступом обеспечьте другой способ подключения или явно настройте VPN для загрузки.',
        version: 'Версия',
