  ...
  translation: {
    ...
    settings: {
      ...
      tailscale: {
        ...
        swap: {
          title: 'Swap память',
          tip: 'Если проблемы сохраняются после включения оптимизации памяти, попробуйте включить swap. По умолчанию размер файла подкачки составляет 256МБ, его можно изменить в "Настройки > Устройство".'
        },
        ...
        loading: 'Загрузка...',
        notRunning: 'Tailscale не запущен. Запустите для продолжения.',
        run: 'Запустить',
        ...
        cancelBtn: 'Нет',
        error: {
          title: 'Ошибка операции Tailscale',
          intro: 'Детали ошибки:',
          stepWait: '1. Подождите 10-15 секунд и повторите действие.',
          stepRestartUI: '2. Нажмите кнопку "Перезапустить сервис" ниже.',
          stepRestartSSH: '3. При необходимости выполните: /etc/init.d/S98tailscaled restart',
          stepReboot: '4. Перезагружайте NanoKVM только если шаги выше не помогли.',
          restartButton: 'Перезапустить сервис',
      ...
      netbird: {
        ...
        install: 'Установить',
        installing: 'Установка',
        notRunning: 'Сервис NetBird не запущен.',
        run: 'Запустить',
        connectTitle: 'Подключение к NetBird',
        officialServer: 'Официальный сервер',
        customServer: 'Свой сервер',
        login: 'Войти через NetBird',
        urlPeriod: 'Ссылка действительна 10 минут',
        loginSuccess: 'Я уже вошёл',
        setupKey: 'Setup Key',
        managementUrl: 'Management URL',
        adminUrl: 'Admin URL (необязательно)',
        connect: 'Подключить',
        invalidInput: 'Необходимо указать Setup Key и Management URL.',
        state: 'Состояние',
        running: 'Работает',
        stopped: 'Остановлен',
        deviceName: 'Имя устройства',
        ...
        stop: 'Остановить',
        stopConfirm: 'Остановить сервис NetBird?',
        okBtn: 'Да',
        cancelBtn: 'Нет',
        error: {
          title: 'Ошибка операции NetBird',
          intro: 'Детали ошибки:',
          stepWait: '1. Подождите 10-15 секунд и повторите действие.',
          stepRestartUI: '2. Нажмите кнопку "Перезапустить сервис" ниже.',
      ...
      update: {
        ...
        offline: {
          title: 'Офлайн-обновление',
          desc: 'Обновление через локальный установочный пакет',
          upload: 'Загрузить',
          invalidName: 'Неверный формат имени файла. Скачайте с GitHub releases.',
          updateFailed: 'Обновление не удалось. Попробуйте ещё раз.'
        }
      },
      account: {
        title: 'Аккаунт',
