  ...
  translation: {
    ...
    settings: {
      ...
      tailscale: {
        ...
        autostartWarning:
          'โปรดตรวจสอบก่อนว่าเข้าถึงอุปกรณ์นี้ผ่าน Tailscale ได้ การหยุด NetBird จะตัดการเชื่อมต่อที่คุณใช้อยู่ตอนนี้',
        memory: {
        ...
        stopWarning:
          'หากคุณเชื่อมต่อผ่าน Tailscale การทำนี้จะตัดการเชื่อมต่อนั้น จะไม่กลับมาเอง โปรดตรวจสอบว่ามีช่องทางเข้าถึงอื่น',
        loading: 'กำลังโหลด...',
      ...
      netbird: {
        ...
        autostartWarning:
          'โปรดตรวจสอบก่อนว่าเข้าถึงอุปกรณ์นี้ผ่าน NetBird ได้ การหยุด Tailscale จะตัดการเชื่อมต่อที่คุณใช้อยู่ตอนนี้',
        ...
        stopWarning:
          'หากคุณเชื่อมต่อผ่าน NetBird การทำนี้จะตัดการเชื่อมต่อนั้น จะกลับมาเมื่อบูตครั้งถัดไป ตราบใดที่เปิดเริ่มอัตโนมัติของ NetBird ไว้',
        loading: 'กำลังโหลด...',
        ...
        uninstallWarning:
          'หากคุณเชื่อมต่อผ่าน NetBird การทำนี้จะตัดการเชื่อมต่อนั้น จะไม่มี VPN อื่นถูกเปิดใช้หรือเลือกโดยอัตโนมัติ ก่อนเข้าถึงจากระยะไกล โปรดเตรียมช่องทางอื่นหรือกำหนดค่า VPN สำหรับบูตอย่างชัดเจน',
        version: 'เวอร์ชัน',
