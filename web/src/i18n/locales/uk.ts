  ...
  translation: {
    ...
    settings: {
      ...
      tailscale: {
        ...
        autostartWarning:
          "Спершу переконайтеся, що до пристрою можна дістатися через Tailscale. Зупинка NetBird розірве з'єднання, яким ви користуєтеся зараз.",
        memory: {
        ...
        stopWarning:
          "Якщо ви підключені через Tailscale, це розірве ваше з'єднання. Само воно не відновиться — переконайтеся, що маєте інший спосіб підключитися.",
        loading: 'Завантаження...',
      ...
      netbird: {
        ...
        autostartWarning:
          "Спершу переконайтеся, що до пристрою можна дістатися через NetBird. Зупинка Tailscale розірве з'єднання, яким ви користуєтеся зараз.",
        ...
        stopWarning:
          "Якщо ви підключені через NetBird, це розірве ваше з'єднання. Воно відновиться під час наступного завантаження, поки автозапуск NetBird увімкнено.",
        loading: 'Завантаження...',
        ...
        uninstallWarning:
          'Якщо ви підключені через NetBird, це розірве ваше з\'єднання. Інша VPN не буде автоматично увімкнена або вибрана; перед віддаленим доступом забезпечте інший спосіб підключення або явно налаштуйте VPN для завантаження.',
        version: 'Версія',
